      ...
      <div v-if="account" class="space-y-5">
        ...
        <div class="space-y-2">
          <div class="flex items-center gap-2">
            ...
            <span
              v-if="nativeBalance !== null"
              class="px-3 py-1 rounded-full bg-indigo-100 text-indigo-700 font-semibold"
            >
              {{ nativeBalance.toFixed(4) }}
            </span>
            <Loader2 v-else-if="loading" class="w-4 h-4 animate-spin text-gray-400" />
            <span v-else class="text-gray-400">0.0000</span>
          </div>

          <div class="flex items-center gap-2">
            <span class="text-gray-700 font-medium">USDC:</span>
            <span
              v-if="usdcBalance !== null"
              class="px-3 py-1 rounded-full bg-indigo-100 text-indigo-700 font-semibold"
            >
