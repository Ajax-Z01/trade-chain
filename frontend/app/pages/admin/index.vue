...
>
  <div>
    ...
    <p class="mt-1 text-indigo-100 dark:text-gray-300">
      Manage your wallets, contracts, and transactions efficiently.
    </p>
  </div>
  <div>
    <button
...
<section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
  ...
  >
    ...
    <div>
      ...
      <p class="text-gray-500 dark:text-gray-400 text-sm">Total connected wallets</p>
  ...
  >
    ...
    <div>
      ...
      <p class="text-gray-500 dark:text-gray-400 text-sm">Latest activity on your network</p>
...
<section class="bg-white dark:bg-gray-900 rounded-xl shadow p-5 mt-6 ring-1 ring-gray-200 dark:ring-gray-700">
  <h3 class="text-lg font-semibold mb-4 text-indigo-600 dark:text-indigo-400">Wallet Balances</h3>
