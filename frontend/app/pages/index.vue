...
import { Wallet, FileText, Activity } from 'lucide-vue-next'
  ...
  <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    >
      ...
      <div>
        ...
        <div class="text-3xl font-bold text-indigo-600 mt-1">{{ totalWallets }}</div>
      </div>
    </div>
    ...
    >
      ...
      <div>
        ...
        <div class="text-3xl font-bold text-green-600 mt-1">{{ totalContracts }}</div>
      </div>
    </div>
    ...
    >
      ...
      <div>
        ...
        <div class="text-3xl font-bold text-orange-600 mt-1">{{ totalRecentTxs }}</div>
      </div>
    </div>
  </section>
        ...
        <tbody>
          ...
          >
            ...
            <td class="p-3 font-semibold">
              <span
                :class="wallet.balance > 0 ? 'bg-green-100 text-green-700 px-2 py-1 rounded-full text-sm' : 'bg-red-100 text-red-700 px-2 py-1 rounded-full text-sm'"
              >
