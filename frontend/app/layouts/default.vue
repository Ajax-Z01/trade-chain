...
<template>
  <div>
    ...
    <!-- Actual Layout -->
    <div v-else class="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <!-- Footer -->
      <footer class="bg-white dark:bg-gray-900 shadow-inner p-4 text-center text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300">
